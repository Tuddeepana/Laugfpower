             ...
             <div data-aos="fade-down">
                 ...
                 <div className='flex max-w-6xl mt-2 text-justify'>
                     <p className='mt-2 leading-relaxed'>
                         As a prominent figure in Sri Lanka’s renewable energy landscape, we offer a range of rewarding
                         career paths in the sector. Explore our current job openings
