          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="mt-6 space-y-5">
                <li><a href="#" aria-label="Milestones" className="flex text-sm text-gray-800 transition-all duration-200 hover:text-blue-600 focus:text-blue-600">MILESTONES</a></li>
                <li><a href="#" aria-label="About Us" className="flex text-sm text-gray-800 transition-all duration-200 hover:text-blue-600 focus:text-blue-600">ABOUT US</a></li>
                ...
                <li><a href="#" aria-label="Board of Directors" className="flex text-sm text-gray-800 transition-all duration-200 hover:text-blue-600 focus:text-blue-600">BOARD OF DIRECTORS</a></li>
              </ul>
            </div>
            <div className="lg:col-span-2">
